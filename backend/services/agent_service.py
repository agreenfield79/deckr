...
_PIPELINE_PROMPTS: dict[str, str] = {
    ...
    "deckr": (
        ...
        "Output all 8 sections using ## N. Section Name format: "
        "## 1. Header, ## 2. Company Overview & History, ## 3. Use of Proceeds, "
        "## 4. Performance Summary, ## 5. Partnership Value, ## 6. Proposed Loan Structure, "
        "## 7. Transaction Timeline, ## 8. Projections. "
